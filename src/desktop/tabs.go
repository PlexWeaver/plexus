...
func topicTitlesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".plexus", topicTitlesFile)
}
...
func topicTitleSourcesPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".plexus", topicTitleSourcesFile)
}
...
func topicCreatedAtsPath(workspaceRoot string) string {
	...
	return filepath.Join(workspaceRoot, ".plexus", topicCreatedAtsFile)
}
...
func globalWorkspaceRoot() string {
	// Honor PLEXUS_HOME so Plexus can use a completely separate workspace.
	...
	if err != nil {
		home, _ := os.UserHomeDir()
		return filepath.Join(home, ".plexus", "global-workspace")
	}
	return filepath.Join(dir, "plexus", "global-workspace")
}
