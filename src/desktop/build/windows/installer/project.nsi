...
####
## Plexus per-user NSIS installer.
##
...
##      forces the user back to %LOCALAPPDATA%\Programs\Plexus even if they had
##      moved the install to a different drive (e.g. D:\Tools\Plexus); the silent
...
!macro reasonix.writeUninstaller
    ...
    # user back to %LOCALAPPDATA%\Programs\Plexus even if they had moved
    # the install to a different drive (e.g. D:\Tools\Plexus). The auto-
