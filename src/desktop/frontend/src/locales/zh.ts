...
export const zh: Record<DictKey, string> = {
  ...
  "caps.reportedReadOnlyTitle": "此 MCP 服务器声明了 readOnlyHint；Plexus 会在规划需要时询问一次，也可在这里预先信任",
  ...
  // 输入框
  "composer.placeholder": "给 Plexus 发消息…  ( / 命令 · @ 文件 · ! 终端 )",
  ...
  "heartbeat.noTasks": "暂无心跳任务。点击「添加任务」创建一个。\n\n提示：AI 代理也可直接编辑 Plexus 用户状态目录中的 heartbeat-tasks.json。",
  "heartbeat.every": "每",
  ...
  "heartbeat.configHint": "AI 代理也可直接编辑 Plexus 用户状态目录中的 heartbeat-tasks.json。",
  ...
  "memory.emptySavedBody": "只保存对后续 Plexus 会话有帮助的长期背景。",
  ...
  "settings.closeBehavior.quit": "退出 Plexus",
  ...
  "settings.botInstallSubtitle": "连接完成后即可在聊天里调用 Plexus。",
  ...
  "settings.botInstallManualQQ": "填写 App ID 和 App Secret；密钥只保存到 Plexus 全局 .env。",
  ...
  "settings.pageDesc.memory": "管理 Plexus 会长期参考的偏好、项目约定和指令文件。",
  ...
  "settings.addProvider.officialChoiceHint": "从 Plexus 预设的 DeepSeek 接入中选择。",
  ...
  "settings.hooksGlobalHint": "保存为全局配置。重启 Plexus 后加载新的 hooks。",
  "settings.hooksProjectHint": "保存在当前工作区。项目 hooks 需要信任，并在重启 Plexus 后加载。",
  ...
  "updater.autoCheckHint": "关闭后，Plexus 打开时不会自动检查更新；你仍可在此页手动检查。",
  ...
  "onboarding.title": "连接 Plexus",
  "onboarding.tagline": "粘贴一个 DeepSeek API key 即可开始。密钥仅保存到 Plexus 全局 .env，仅用于 provider 请求。",
  ...
  "onboarding.privacy": "仅保存在 Plexus 全局 .env",
  ...
  // 崩溃兜底页
  "crash.title": "Plexus 遇到错误 —— 可以一键发送报告，或复制后反馈",
  "crash.copy": "复制",
  "crash.send": "发送报告",
  "crash.sending": "发送中…",
  "crash.sent": "已发送，谢谢！",
  ...
  "performanceReport.title": "Plexus 检测到响应卡顿",
