...
export const en = {
  ...
  "sidebar.navigation": "Plexus navigation",
  ...
  "caps.reportedReadOnlyTitle": "This MCP server reports readOnlyHint; Plexus asks once when planning needs it, or you can pre-trust it here",
  ...
  // composer
  "composer.placeholder": "Message Plexus…  ( / commands · @ files · ! shell )",
  ...
  "heartbeat.noTasks": "No heartbeat tasks yet. Click \"Add task\" to create one.\n\nTip: AI agents can also edit heartbeat-tasks.json in the Plexus user state folder.",
  ...
  "heartbeat.configHint": "AI agents can also edit heartbeat-tasks.json in the Plexus user state folder.",
  ...
  "memory.emptySavedBody": "Save durable background only when it should help future Plexus sessions in this project.",
  ...
  "settings.closeBehavior.quit": "Quit Plexus",
  ...
  "settings.botInstallSubtitle": "Once connected, Plexus can be used from chat.",
  ...
  "settings.botInstallManualQQ": "Enter the App ID and App secret. The secret is stored only in Plexus home .env.",
  ...
  "settings.pageDesc.memory": "Manage preferences, project conventions, and instruction files Plexus keeps referencing.",
  ...
  "settings.addProvider.officialChoiceHint": "Choose from Plexus presets for DeepSeek.",
  ...
  "settings.hooksGlobalHint": "Saved globally. Restart Plexus to load new hooks.",
  "settings.hooksProjectHint": "Saved in this workspace. Project hooks load after trust and a Plexus restart.",
  ...
  "updater.autoCheckHint": "When off, Plexus won't check automatically when it opens. You can still check manually here.",
  ...
  "updater.installing": "Installing — Plexus will restart…",
  ...
  "onboarding.title": "Connect Plexus",
  "onboarding.tagline": "Paste a DeepSeek API key to start. Stored in Plexus home .env and used only for provider requests.",
  ...
  "onboarding.privacy": "Stored only in Plexus home .env",
  ...
  // crash page
  "crash.title": "Plexus hit an error — send us the report, or copy it",
  "crash.copy": "Copy",
  ...
  "performanceReport.title": "Plexus noticed a responsiveness issue",
