...
function makeMockApp(): AppBindings {
  ...
  const settings: SettingsView = {
    ...
    agent: { temperature: 0.2, maxSteps: 0, plannerMaxSteps: 0, systemPrompt: "You are Plexus, a coding agent.", coldResumePrune: true, reasoningLanguage: "auto" },
    bot: {
      enabled: !freshMock,
      model: "",
        ...
        skills: [
          {
            ...
            description: "Review or update a Plexus GitHub PR, address feedback, verify, and publish safely.",
            scope: "project",
            body: "# Plexus PR Followup\n\nUse this skill for repeated Plexus PR work.\n\n## Workflow\n\n1. Confirm branch and PR state.\n2. Inspect the diff.\n3. Fix actionable feedback.\n4. Verify and update the PR.\n",
