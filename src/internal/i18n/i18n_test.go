...
// $LC_ALL / $PLEXUS_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that PLEXUS_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("PLEXUS_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("PLEXUS_LANG=en overriding LANG=zh: got %q, want en", got)
	}
